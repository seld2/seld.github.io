...
array('id' => 'ttr_copyright', 'std' => '#000000'), 
 array('id' => 'ttr_designedbylink', 'std' => '#000000'),
array('id' => 'ttr_designedby', 'std' => '#B30000'),
...
'right' => __( 'Sidebar-2 Menu',CURRENT_THEME )
)
);
}
...
"type" => "checkbox",
"std" => "true"),
array("name" => __("Use vertical menu on Sidebar-2",CURRENT_THEME),
"desc" => "Check this box if you would like to ENABLE the vertical menu.",
"id" => "ttr_right_menu_enable",
"type"=> "checkbox",
"std"=> ""),
...
array("name" => __("Display Header Logo",CURRENT_THEME),
"desc" => "Check this box if you would like to ENABLE the header logo.",
"id" => "ttr_header_logo_enable",
"std" => "true",
"type" => "checkbox"),
array("name" => __("Header Logo",CURRENT_THEME),
"desc" => "Choose logo for Header.",
"id" => "ttr_logo",
"std" => "logo.png",
"type" => "media"),
array("type" => "close")
...
"type"=> "title"),
array("type" => "open"),
array( "name" => __("Footer Copyright Text",CURRENT_THEME),
"desc" => "Enter copyright text",
"id"=> "ttr_copyright_text",
"type" => "textarea",
"std" => "Copyright@Example.com"),
array( "name" => __("Footer Copyright URL",CURRENT_THEME),
"desc" => "Enter copyright url",
"id"=> "ttr_copyright_url",
"type" => "textarea",
"std" => "$copyright_url"),
array( "name" => __("Display Footer Copyright",CURRENT_THEME),
"desc" => "Check this box if you would like to ENABLE the footer copyright",
"id"=> "ttr_copyright_disable",
"type" => "checkbox",
"std" => "true"),
array("name" => __("Footer Copyright Font Size",CURRENT_THEME),
"desc" =>"Enter the font size of Footer Copyright.",
"id" => "ttr_font_size_copyright",
"std" => "8",
"type" => "text"),
...
"std"=> "10",
"type" => "text"),
array("name" => __("RSS Icon",CURRENT_THEME),
"desc" =>"Choose icon for RSS.",
"id" => "ttr_rss",
"std"=> "footerrss.png",
"type" => "media"),
array( "name" => __("Display RSS Icon",CURRENT_THEME),
"desc" => "Check this box if you would like to ENABLE the RSS Icon",
"id"=> "ttr_rss_enable",
"type" => "checkbox",
"std" => "true"),
array("type" => "close")

...
<?php settings_fields('heateor_sc_options'); ?>
	...
	<div class="menu_containt_div" id="tabs-1">
		...
		<div class="stuffbox">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form-table editcomment menu_content_table">
				...
				<tr>
					...
					<label for="heateor_sc_comment_count"><?php _e("Show Counts", 'heateor-social-comments'); ?></label>
					</th>
					<td>
		...
		<div class="stuffbox">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form-table editcomment menu_content_table">
				...
				<tr class="heateor_help_content" id="heateor_sc_fb_comment_url_help_cont">
					<td colspan="2">
					<div>
					<?php _e('The absolute URL that comments posted will be permanently associated with. Stories on Facebook about comments posted, will link to this URL.<br/>If left empty <strong>(Recommended)</strong>, url of the webpage will be used at which commenting is enabled.', 'heateor-social-comments') ?>
					</div>
					</td>
				</tr>
				...
				<tr>
					<td colspan="2">
					<div>
					<a href="https://www.heateor.com/facebook-comments-moderation" target="_blank"><input type="button" value="<?php _e('Show Recent Facebook Comments in a Widget', 'heateor-social-comments') ?>" class="ss_demo" /></a>
					</div>
					</td>
				</tr>
				...
				<tr>
					<td colspan="2">
					<div>
					<a href="https://www.heateor.com/facebook-comments-moderation" target="_blank"><input type="button" value="<?php _e('Recover Facebook Comments Lost After Moving to SSL/Https', 'heateor-social-comments') ?>" class="ss_demo" /></a>
					</div>
					</td>
				</tr>
				...
				<tr class="heateor_help_content" id="heateor_sc_fb_comment_lang_help_cont">
					<td colspan="2">
					<div>
					<?php echo sprintf(__('Enter the code of the language you want to use to display commenting. You can find the language codes at <a href="%s" target="_blank">this link</a>. Leave it empty for default language(English)', 'heateor-social-comments'), '//www.facebook.com/translations/FacebookLocales.xml') ?>
					</div>
					</td>
				</tr>
			</table>
		...
		<div class="stuffbox">
			<h3><label><?php _e('Google Plus Comments Options', 'heateor-social-comments');?></label></h3>
			<div class="inside">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form-table editcomment menu_content_table">
				<tr>
					<th>
					<img id="heateor_sc_enable_gpcomments_help" class="heateor_help_bubble" src="<?php echo plugins_url('../images/info.png', __FILE__) ?>" />
					<label for="heateor_sc_enable_gpcomments"><?php _e("Enable Google Plus Comments", 'heateor-social-comments'); ?></label>
					</th>
					<td>
				...
				<tr class="heateor_help_content" id="heateor_sc_enable_gpcomments_help_cont">
					<td colspan="2">
					<div>
					<?php _e('Enable Google Plus Commenting', 'heateor-social-comments') ?>
					</div>
					</td>
				</tr>
				...
				<tr>
					...
					<label for="heateor_sc_gp_comment_label"><?php _e("Google Plus Comments label", 'heateor-social-comments'); ?></label>
					</th>
					<td>
				...
				<tr class="heateor_help_content" id="heateor_sc_gp_comment_label_help_cont">
					<td colspan="2">
					<div>
					<?php _e('Leave empty to display only Google Plus icon in its tab', 'heateor-social-comments') ?>
					</div>
					</td>
				</tr>
				...
				<tr class="heateor_sc_tabbed_option">
					...
					<label for="heateor_sc_gp_comment_icon"><?php _e("Show Google Plus icon in its tab", 'heateor-social-comments'); ?></label>
					</th>
					<td>
				...
				<tr class="heateor_help_content" id="heateor_sc_gp_comment_icon_help_cont">
					<td colspan="2">
					<div>
					<?php _e('Enable to display Google Plus icon in its tab', 'heateor-social-comments') ?>
					</div>
					</td>
				</tr>
				...
				<tr>
					...
					<label for="heateor_sc_gpcomments_width"><?php _e("Width", 'heateor-social-comments'); ?></label>
					</th>
					<td>
				...
				<tr class="heateor_help_content" id="heateor_sc_gpcomments_width_help_cont">
					<td colspan="2">
					<div>
					<?php _e('Width of GooglePlus Commenting interface. Leave empty for auto adjust', 'heateor-social-comments') ?>
					</div>
					</td>
				</tr>
				...
				<tr>
					...
					<label for="heateor_sc_gpcomments_url"><?php _e("Url to comment on", 'heateor-social-comments'); ?></label>
					</th>
					<td>
				...
				<tr class="heateor_help_content" id="heateor_sc_gpcomments_url_help_cont">
					<td colspan="2">
					<div>
					<?php _e('The absolute URL that comments posted will be permanently associated with. Stories on Google Plus about comments posted, will link to this URL.<br/>If left empty <strong>(Recommended)</strong>, url of the webpage will be used at which commenting is enabled.', 'heateor-social-comments') ?>
					</div>
					</td>
				</tr>
			</table>
	...
	<div class="menu_containt_div" id="tabs-3">
		...
		<div class="stuffbox">
			...
			<div class="inside">
				<p><?php _e('<strong>Note:</strong> Plugin will not work on local server. You should have an online website for the plugin to function properly.', 'heateor-social-comments'); ?></p>
				...
				<p><a style="text-decoration:none" href="http://support.heateor.com/recover-facebook-comments-wordpress-moving-to-https-ssl" target="_blank"><?php _e('How to recover Facebook Comments lost after moving to SSL/Https?', 'heateor-social-comments') ?></a></p>
...
<div class="stuffbox">
	...
	<div class="inside">
	<p><?php _e( 'If you can send (to hello@heateor.com) how our plugin is helping your business, we can share it on Instagram. You can also send any relevant hashtags and people to mention in the Instagram post.', 'heateor-social-comments' ) ?></p>
	<p><?php _e( '<b>Example</b> - Blah-Blah Online Coaching teaches various programming language courses through their website. They have emerged as one of the most popular online coaching websites in the past year. Anyone can become proficient in programming language of their choice in a very easy way in no time.', 'heateor-social-comments' ) ?></p>
	<p><?php _e( '@blahblahonlinecoaching proudly use #HeateorSocialComments to enable social commenting at their website. Be sure to visit their website at blahblahonlinecoaching.com where you can browse a variety of programming language courses.', 'heateor-social-comments' ) ?></p>
	</div>
</div>
</div>
</div>
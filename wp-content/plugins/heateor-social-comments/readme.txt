...
Donate link: https://www.heateor.com/donate/?action=Heateor+Social+Comments
Tags: social comments, social commenting, facebook comments, disqus comments, google+ comments, comments notification, facebook comment notification, comment moderation, comments, wordpress comments, social plugin
Requires at least: 2.5.0
Tested up to: 4.8
Stable tag: 1.4.10
License: GPLv2 or later

Integrate Facebook Comments, Google+ Comments and/or Disqus Comments at your website

== Description ==
**Note:** Plugin will not work on local server. You should have an online website for the plugin to function properly.

This plugin let you transform the commenting system of your website. You can enable Facebook Comments, Google+ Comments, Disqus Comments and/or default WordPress comments simultaneously. You have full control over which of these four commenting systems you want to enable. You can choose between stacked and tabbed interface with re-ordering of the comments.

= Features: =
1. Enable **Facebook Comments**
2. Enable **Google+ Comments**
3. Enable **Disqus Comments**
4. Choose between **Tabbed and Stacked layouts**
5. **Rearrange order** of enabled commenting systems
6. **Customize labels** for individual comment system as well as combined comment system
7. **Show/Hide comment counts** for individual comment system
8. Options to **enable Social Commenting on default post types (posts, pages) as well as custom post types** which support comments
9. Enable **Social Comments with/without default comments system**
10. **Customizable behavior for individual comment system**, like - Target Url, language, width of commenting interface, label etc. 
...
= Important links =
* <a target="_blank" href="https://www.heateor.com/heateor-social-comments#live_demo">Plugin Demo</a>
...
* <a target="_blank" href="http://support.heateor.com/social-comments-shortcode/">Shortcode</a>
